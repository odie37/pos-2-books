 ...
 *       &lt;sequence>
 *         &lt;element name="accounts" type="{http://e-conomic.com}ArrayOfAccountHandle" minOccurs="0"/>
...
@XmlRootElement(name = "Account_GetEntryTotalsByDate")
public class AccountGetEntryTotalsByDate {

    protected ArrayOfAccountHandle accounts;
     ...
     *     
     */
    public ArrayOfAccountHandle getAccounts() {
        return accounts;
    }
     ...
     *     
     */
    public void setAccounts(ArrayOfAccountHandle value) {
        this.accounts = value;
    }
