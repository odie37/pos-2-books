 ...
 *         &lt;element name="valueHandle" type="{http://e-conomic.com}VatAccountHandle" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CashBookEntry_SetContraVatAccount")
public class CashBookEntrySetContraVatAccount {

    protected CashBookEntryHandle cashBookEntryHandle;
    protected VatAccountHandle valueHandle;
     ...
     *     
     */
    public VatAccountHandle getValueHandle() {
        return valueHandle;
    }
     ...
     *     
     */
    public void setValueHandle(VatAccountHandle value) {
