 ...
 *         &lt;element name="valueHandle" type="{http://e-conomic.com}CreditorContactHandle" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Creditor_SetAttention")
public class CreditorSetAttention {

    protected CreditorHandle creditorHandle;
    protected CreditorContactHandle valueHandle;
     ...
     *     
     */
    public CreditorContactHandle getValueHandle() {
        return valueHandle;
    }
     ...
     *     
     */
    public void setValueHandle(CreditorContactHandle value) {
