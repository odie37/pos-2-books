 ...
 *         &lt;element name="valueHandle" type="{http://e-conomic.com}DebtorGroupHandle" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Debtor_SetDebtorGroup")
public class DebtorSetDebtorGroup {

    protected DebtorHandle debtorHandle;
    protected DebtorGroupHandle valueHandle;
     ...
     *     
     */
    public DebtorGroupHandle getValueHandle() {
        return valueHandle;
    }
     ...
     *     
     */
    public void setValueHandle(DebtorGroupHandle value) {
