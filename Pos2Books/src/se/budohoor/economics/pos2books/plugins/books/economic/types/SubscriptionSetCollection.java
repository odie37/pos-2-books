 ...
 *         &lt;element name="value" type="{http://e-conomic.com}SubscriptionCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Subscription_SetCollection")
public class SubscriptionSetCollection {

    protected SubscriptionHandle subscriptionHandle;
    @XmlElement(required = true)
    protected SubscriptionCollection value;
     ...
     *     
     */
    public SubscriptionCollection getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(SubscriptionCollection value) {
        this.value = value;
    }
