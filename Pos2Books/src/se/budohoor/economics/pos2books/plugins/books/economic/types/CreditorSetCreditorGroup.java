 ...
 *         &lt;element name="valueHandle" type="{http://e-conomic.com}CreditorGroupHandle" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Creditor_SetCreditorGroup")
public class CreditorSetCreditorGroup {

    protected CreditorHandle creditorHandle;
    protected CreditorGroupHandle valueHandle;
     ...
     *     
     */
    public CreditorGroupHandle getValueHandle() {
        return valueHandle;
    }
     ...
     *     
     */
    public void setValueHandle(CreditorGroupHandle value) {
