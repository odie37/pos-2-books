...
public class MemberData {
    private static final int MEMBER_NR_COL = 4;         //3
    private static final int MEMBER_NAME_COL = 5;       //4
    private static final int EMAIL_COL = 8;             //5
    private static final int ADDRESS_COL = 9;           //6
    private static final int ZIP_COL = 10;               //7
    private static final int CITY_COL = 11;              //8
    private static final int PARENT_COL = 14;            //9
    private static final int AMOUNT_COL = 15;           //10
    private static final int INVOICE_NR_COL = 16;       //11
    ...
    public MemberData(XSSFRow dataRow) {
        ...
        //log.info("Row data: " + dataRow.toString());
        ...
        zipCode = "" + dataRow.getCell(ZIP_COL).getRawValue();
        ...
        try {
            ...
            amount = Integer.parseInt(dataRow.getCell(AMOUNT_COL).getRawValue());
